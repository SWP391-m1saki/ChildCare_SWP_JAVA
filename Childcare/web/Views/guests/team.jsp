        ...
        <div class="container-fluid py-5">
            <div class="container w-75">
                <div class="text-center mx-auto mb-5" style="max-width: 500px;">
                    <h5 class="d-inline-block text-primary text-uppercase border-bottom border-5">Danh sách bác sĩ hàng đầu</h5>
                </div>
                <div >
                        ...
                        <div class="team-item">
                            <div class="row g-0 bg-light rounded overflow-hidden">
                                <div class="col-12 col-sm-3 h-100 p-3">
                                    <img class="img-fluid h-100" width="300" height="300" src="${context}/img/${d.user.avatar}" style="object-fit: cover;">
                                </div>
