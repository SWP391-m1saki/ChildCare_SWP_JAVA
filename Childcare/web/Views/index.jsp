    ...
    <body>
        <style>
            ...
            .hr-style{
                ...
                border-top: 2px dashed rgb(228, 232, 236);
                max-width: 1120px;
                margin: 0 auto;
            }
        </style>
                        ...
                        <div class="post col-xl-4 col-lg-6" >
                            <div class="bg-light rounded overflow-hidden" style="height: 460px">
                                <a href="${pageContext.request.contextPath}/bai-viet?id=${post.postId}">
                                    <img class="img-fluid w-100" style="aspect-ratio: 3 / 2; border: 1px solid #e2e1e1c2;" src="${pageContext.request.contextPath}/img/${post.image}" alt="">
                                </a>
                                <div class="p-4">
