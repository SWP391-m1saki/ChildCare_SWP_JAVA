                        ...
                        <header class="card-header">
                            <div class="row gx-3">
                                <div class="col-lg-4 col-md-6 me-auto">
                                    <input type="text" name="search" form="main-form" placeholder="Tìm kiếm tên bài viết" class="form-control" value="${requestScope.search}">
                                </div>
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <c:forEach items="${requestScope.postList}" var="p">
                                            <tr>
                                                ...
                                                <td>${p.title}</td>
                                                <td><fmt:formatDate pattern="dd/MM/yyyy" value="${p.createdAt}"></fmt:formatDate></td>
                                                    <td class="text-end">
