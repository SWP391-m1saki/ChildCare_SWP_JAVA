 ...
 * @author Admin
 */
public class ShiftAddDoctor extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (shift_string != null) {
            ...
            shiftDAO.addDoctorToShift(week_number, dayOfWeek, isMorningShift, doctorId);
            response.sendRedirect("../schedule/detail?weeknum=" + week_number + "&shift=" + shift_string + "");
        }
    }
