...
//            request.getSession().setAttribute("mess", "Thêm bài viết thành công");
//            request.getRequestDispatcher("../../Views/manager/createPost.jsp").forward(request, response);
//        }
//    }
//
...
////        request.setAttribute("mess", new ArrayList<String>() {
////            {
////                add("success");
////                add("Chỉnh sửa bài viết thành công");
////            }
////        });
...
//            //Hien thi message
//            request.getSession().removeAttribute("mess");
//            request.getSession().setAttribute("mess", new String[]{"error", "Xóa thất bại. Bài viết không tồn tại"});
//        } else {
//            post.setPostId(postId);
//            postDao.delete(post);
//            request.getSession().removeAttribute("mess");
//            request.getSession().setAttribute("mess", new String[]{"error", "Xóa bài viết thành công"});
//        }
